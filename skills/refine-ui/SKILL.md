...
3. Call the Skill tool twice, for "better-ui" and "emil-design-eng". Walk the target against both catalogs, slowly: every state the component defines (hover, focus, active, loading, empty, error), motion replayed at 10% speed when a browser is available.
