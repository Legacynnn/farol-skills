...
4. Call the Skill tool twice, for "better-ui" and "emil-design-eng", and apply both catalogs to the changed surfaces. Add the floor checks: accessible names, keyboard reach, visible focus, 320px, contrast, colour-only meaning, reduced motion, destructive confirmation, copy in the `DESIGN.md` voice.
